...
reports={}
for folder in ['browser-acceptance','production-acceptance','production-browser','common-vision-api','common-vision-browser','media-browser','media-windows','common-vision-windows','ecosystem-api']:
...
instructions=(root/'README_FIRST.txt').read_text()
(out/'README_FIRST_v1.9.0.txt').write_text(instructions)
recovery=f'''# Open Studio release checkpoint — v1.9.0
...
live Hugging Face/Civitai model discovery and verified imports; starter packs;
Stability Matrix installation, package launch and existing shared-library reuse;
native and ComfyUI generation adapters; combined first-run setup and diagnostics;
...
files={'ORIGIN0.exe':out/'ORIGIN0.exe','README_FIRST.txt':out/'README_FIRST_v1.9.0.txt','MEDIA_VALIDATION.json':out/'MEDIA_VALIDATION.json','MEDIA_RECOVERY.md':out/'MEDIA_RECOVERY.md'}
...
package=out/'ORIGIN0_OPEN_STUDIO_WINDOWS_v1.9.0.zip'
