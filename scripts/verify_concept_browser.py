    ...
    with tempfile.TemporaryDirectory(prefix='origin0-concept-browser-') as base:
        ...
        try:
            ...
            with sync_playwright() as pw:
                ...
                page.locator('#concept-preset').select_option('horizontal')
                expect(page.locator('#concept-attrs input')).not_to_have_count(0)
                page.locator('#concept-upload-license').select_option('owned')
                expect(page.locator('#concept-upload-license')).to_have_value('owned')
                ...
                expect(card.locator('[data-example-license]')).to_have_value('cc0')
                card.locator('[data-example-license]').select_option('permission')
                ...
                expect(page.locator('#cv-status')).to_contain_text('Local workspace ready')
                page.get_by_role('button', name='Image studio', exact=True).click()
