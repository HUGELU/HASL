import {cameraAssets} from "../lib/camera_assets.js";

import { CAMERA_MAP, LENS_MAP, FOCAL_PERSPECTIVE, APERTURE_EFFECT } from '../lib/promptUtils.js';

const ASSET_URLS = {
    // CAMERA
    "Modular 8K Digital": cameraAssets["assets/cinema/modular_8k_digital.webp"],
    "Full-Frame Cine Digital": cameraAssets["assets/cinema/full_frame_cine_digital.webp"],
    "Grand Format 70mm Film": cameraAssets["assets/cinema/grand_format_70mm_film.webp"],
    "Studio Digital S35": cameraAssets["assets/cinema/studio_digital_s35.webp"],
    "Classic 16mm Film": cameraAssets["assets/cinema/classic_16mm_film.webp"],
    "Premium Large Format Digital": cameraAssets["assets/cinema/premium_large_format_digital.webp"],

    // LENS
    "Creative Tilt Lens": cameraAssets["assets/cinema/creative_tilt_lens.webp"],
    "Compact Anamorphic": cameraAssets["assets/cinema/compact_anamorphic.webp"],
    "Extreme Macro": cameraAssets["assets/cinema/extreme_macro.webp"],
    "70s Cinema Prime": cameraAssets["assets/cinema/70s_cinema_prime.webp"],
    "Classic Anamorphic": cameraAssets["assets/cinema/classic_anamorphic.webp"],
    "Premium Modern Prime": cameraAssets["assets/cinema/premium_modern_prime.webp"],
    "Warm Cinema Prime": cameraAssets["assets/cinema/warm_cinema_prime.webp"],
    "Swirl Bokeh Portrait": cameraAssets["assets/cinema/swirl_bokeh_portrait.webp"],
    "Vintage Prime": cameraAssets["assets/cinema/vintage_prime.webp"],
    "Halation Diffusion": cameraAssets["assets/cinema/halation_diffusion.webp"],
    "Clinical Sharp Prime": cameraAssets["assets/cinema/clinical_sharp_prime.webp"],

    // APERTURE
    "f/1.4": cameraAssets["assets/cinema/f_1_4.webp"],
    "f/4": cameraAssets["assets/cinema/f_4.webp"],
    "f/11": cameraAssets["assets/cinema/f_11.webp"]
};
